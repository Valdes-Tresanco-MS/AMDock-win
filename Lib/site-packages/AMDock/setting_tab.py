...
class Configuration_tab(QtGui.QWidget):
    def __init__(self, parent=None):
        ...
        self.amber.setGeometry(QtCore.QRect(100,20,60,22))
        self.amber.setText('AMBER')

        self.charmm = QtGui.QRadioButton(self.pdb2pqr_box)
        self.charmm.setGeometry(QtCore.QRect(180, 20, 70, 22))
        self.charmm.setText('CHARMM')

        self.parse = QtGui.QRadioButton(self.pdb2pqr_box)
        self.parse.setGeometry(QtCore.QRect(270, 20, 60, 22))
        ...
        self.swanson.setGeometry(QtCore.QRect(520, 20, 80, 22))
