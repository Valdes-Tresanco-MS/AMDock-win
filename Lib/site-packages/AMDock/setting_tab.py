...
class Configuration_tab(QtGui.QWidget):
    ...
    def check_changes(self):
        ...
        if self.cpu != self.AMDock.ncpu or self.exhaustiveness != self.AMDock.exhaustiveness or \
                self.NoPoses != self.AMDock.poses_vina or self.forcefield != self.AMDock.forcefield or \
                self.ga_run != self.AMDock.runs or self.ga_num_eval != self.AMDock.eval or \
                self.rmstol != self.AMDock.rmsd or self.alignment != self.AMDock.prot_align:
