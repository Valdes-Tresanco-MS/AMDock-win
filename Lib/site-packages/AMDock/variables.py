...
class Variables:
    def __init__(self, parent=None):
        ...
        self.program_mode = 'SIMPLE'  ## 'CROSS', 'SCORING'
        self.project_name = "Docking_Project"
        self.input_dir = "input"
        self.result_dir = "result"
        self.protein_path = ""
        self.analog_protein_path = ''
        self.ligand_path = ""
        self.pH = 7.40
        self.od = False
        self.scoring = False
        self.protein_name = None
        self.analog_protein_name = None
        self.ligand_name = None
        self.ligands = None
        self.analog_ligands = None
        self.metals = None
        self.analog_metals = None
        self.selected_ligand = None
        self.analog_selected_ligand = None
        self.grid_def = 'auto'
        self.analog_grid_def = 'auto'
        self.exhaustiveness = 'auto'
        self.poses_vina = 10
        self.runs_AD = 10
        ...
        self.analog_protein_file = None
        self.ligand_file = None
        self.result_file = ''
        self.analog_result_file = ''
        self.best_result_file = ''
        self.best_analog_result_file = ''
        self.input_protein = ''
        self.analog_input_protein = ''
        self.input_ligand = ''
        self.number_cpu = multiprocessing.cpu_count()
        self.ncpu = 1
        self.forcefield = 'AMBER'
        self.protein_h = None
        self.analog_protein_h = None
        self.ligand_h = None
        self.amdock_file = None
        self.state = -1 # -2 running, -1 only PD selected, 0 project, 1 input files, 2 bsd, 3 docking

        self.protein_pqr = None
        self.analog_protein_pqr = None
        self.protein_pdbqt = None
        self.analog_protein_pdbqt = None
        self.protein_pdbqt_file = ''
        self.analog_protein_pdbqt_file = ''
        self.prot_basename = None
        self.analog_protein_basename = None
        self.ligand_pdbqt = None
        self.gd = 'gd.txt'
        self.gd1 = 'gd1.txt'
        self.res_center = 'residues_center.txt'
        self.res_center1 = 'residues_center1.txt'
        self.prev_ligand = 'prev_lig_center.txt'
        self.prev_ligand1 = 'prev_lig_center1.txt'
        self.obj_center = 'obj_center.txt'
        self.obj_center1 = 'obj_center1.txt'
        self.error = 1
        self.errorB = 1
        self.gerror = 1
        self.gerrorB = 1
        self.heavy_atoms = 0
        self.target_prepare = True
        self.offtarget_prepare = True
        self.ligand_prepare = True
        self.input_lig = None
        self.input_target = None
        self.input_offtarget = None
        self.scoring_file = None
        self.prot_align = True
        self.log = False
        ...
        self.prepare_gpf4_py = str(os.path.join(self.extprg_path, 'prepare_gpf4.py'))
        ...
        self.build_pymol = os.path.join(self.extprg_path, 'build_grid.py')
        ...
        self.autodock_scorer = os.path.join(self.python_lib, 'AutoDockTools', 'Utilities24',
                                            'compute_AutoDock41_score.py')

        self.lig_site_pymol = os.path.join(self.extprg_path, 'ligand_site_pymol.py')
        self.protein_cartoon_pymol = os.path.join(self.extprg_path, 'protein_cartoon_pymol.py')
