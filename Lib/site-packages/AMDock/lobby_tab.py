...
class Lobby(QtGui.QFrame):
    ...
    def program_select(self, b):
        ...
        self.AMDock.statusbar.addWidget(QtGui.QLabel(self.AMDock.docking_program + " is selected"))
        self.AMDock.log_widget.textedit.append('AMDOCK: IP > Defining Initial Parameters...')
        self.AMDock.log_widget.textedit.append('AMDOCK: IP > DOCKING_PROGRAM: %s' % self.AMDock.docking_program)
    ...
    def result_select(self, b):
        if b.objectName() == 'vina_result_button':
            self.AMDock.statusbar.showMessage(b.text() + " is selected")
        else:
            self.AMDock.statusbar.showMessage(b.text() + " is selected")
