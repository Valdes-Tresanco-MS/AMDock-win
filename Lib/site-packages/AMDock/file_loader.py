        ...
        if data_file.exec_():
            ...
            if self.AMDock.program_body.target.name == self.AMDock.program_body.offtarget.name:
                ...
                if self.same == QtGui.QMessageBox.Ok:
                    ...
                    self.AMDock.program_body.target_label.hide()
                    self.load_protein()
                ...
                self.t_input = os.path.join(self.AMDock.project.input, self.AMDock.program_body.target.name + '.' +
                                            self.AMDock.program_body.target.ext)
        ...
        if data_file.exec_():
            ...
            if self.AMDock.program_body.offtarget.name == self.AMDock.program_body.target.name:
                ...
                if self.same == QtGui.QMessageBox.Ok:
                    ...
                    self.AMDock.program_body.offtarget_label.hide()
                    self.load_proteinB()
                ...
                self.AMDock.program_body.offtarget_label.setText('Loaded Off-Target from: %s' %
                                                                 self.AMDock.program_body.offtarget.path)
                self.AMDock.program_body.offtarget_text.setText(os.path.basename(self.AMDock.program_body.offtarget.path))

                self.o_input = os.path.join(self.AMDock.project.input, self.AMDock.program_body.offtarget.name + '.' +
                                            self.AMDock.program_body.offtarget.ext)
        ...
        if data_file.exec_():
            ...
            if self.AMDock.program_body.ligand.name == self.AMDock.program_body.target.name:
                ...
                if self.same == QtGui.QMessageBox.Ok:
                    ...
                    self.AMDock.program_body.ligand_label.hide()
                    self.load_ligand()
                ...
                self.l_input = os.path.join(self.AMDock.project.input, self.AMDock.program_body.ligand.name + '.' +
                                            self.AMDock.program_body.ligand.ext)
    ...
    def load_amdock_file(self):
        ...
        if data_file.exec_():
            ...
            for line in self.AMDock.amdock_file:
                ...
                if re.search('>> WORKING_DIRECTORY:', line):
                    if (line.split()[2]).strip() == os.path.split(self.AMDock.amdock_path)[0]:
                        ...
                        self.AMDock.project.WDIR = os.path.split(self.AMDock.amdock_path)[0]
            ...
            if os.path.exists(os.path.join(self.AMDock.project.WDIR, 'input')):
                complete += '0'
                self.AMDock.input_dir = os.path.join(self.AMDock.project.WDIR, 'input')
            else:
                complete += '1'
            # 2
            if os.path.exists(os.path.join(self.AMDock.project.WDIR, 'results')):
                complete += '0'
                self.AMDock.result_dir = os.path.join(self.AMDock.project.WDIR, 'results')
            else:
                complete += '1'
            # 3
