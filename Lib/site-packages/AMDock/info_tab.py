...
class Help(QtGui.QWidget):
    def __init__(self, parent = None):
        ...
        self.documentation_label.setGeometry(QtCore.QRect(10, 15, 300, 25))

        self.documentation_button = QtGui.QPushButton(self.documentation_box)
        self.documentation_button.setGeometry(QtCore.QRect(320, 15, 80, 25))
        ...
        self.citing_box.setGeometry(QtCore.QRect(5, 120, 890, 60))
        ...
        self.citing_label.setGeometry(QtCore.QRect(10, 25, 850, 25))

        self.reference_box = QtGui.QGroupBox(self)
        self.reference_box.setGeometry(QtCore.QRect(5,185 , 890, 400))
        ...
        self.reference_sarea.setGeometry(QtCore.QRect(5, 15, 880, 375))
