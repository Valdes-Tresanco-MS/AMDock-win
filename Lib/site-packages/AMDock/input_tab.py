...
class Program_body(QtGui.QWidget):
    ...
    def grid_actions(self, btn):
        ...
        if btn.objectName() == 'grid_pymol_button' and btn.text() == 'Show in PyMol':
            ...
            visual_arg = [self.parent.ws.pymol, self.parent.v.analog_protein_pdbqt, self.parent.ws.grid_pymol, '--',
                          '-c',
            ...
            build_arg = [self.parent.ws.pymol, self.parent.v.protein_pdbqt, self.parent.ws.build_pymol, '--', '-s',
            ...
            build_arg = [self.parent.ws.pymol, self.parent.v.analog_protein_pdbqt, self.parent.ws.build_pymol, '--',
                         '-s',
                         '%s,%s,%s' % (self.parent.v.rg, self.parent.v.rg,
    ...
    def load_file(self, file):  # ok
        ...
        if file.objectName() == "protein_buttonA":
            if self.target is None:
                self.target = self.parent.loader.load_protein()
            else:
    ...
    def prepare_receptor(self):
        ...
        self.target = PDBINFO(self.target_path)
        print self.target, '##############'
