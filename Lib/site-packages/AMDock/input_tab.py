...
#         # self.AMDock.result_tab.load_button.setEnabled(False)
        ...
        if self.AMDock.docking_program == 'AutoDock Vina':
            ...
            vina_result = os.path.join(self.AMDock.project.results, self.ligand.name + '_h_out.pdbqt')
            ...
            autodock_result = os.path.join(self.AMDock.project.results, self.autodock_dlg)
    ...
    def start_docking_prog(self):
        ...
        if self.AMDock.docking_program == 'AutoDock Vina':
            vina_arg = ['--receptor', self.target.pdbqt, '--ligand', self.ligand.pdbqt, '--center_x',
                        ...
                        self.AMDock.project.results, self.ligand.pdbqt_name + self.target.name + '_out.pdbqt'), "--log",
                        os.path.join(self.AMDock.project.results, self.ligand.pdbqt_name +self.target.name +
                                     '_out.log')]
            ...
            if self.AMDock.project.mode == 1:
                vina_argB = ['--receptor', self.offtarget.pdbqt, '--ligand', self.ligand.pdbqt,'--center_x',
                            ...
                            self.AMDock.project.results, self.ligand.pdbqt_name + self.target.name + '_out2.pdbqt'),
                             "--log", os.path.join(self.AMDock.project.results, self.ligand.pdbqt_name +self.target.name +
                            '_out.log')]
