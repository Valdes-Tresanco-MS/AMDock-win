...
class Program_body(QtGui.QWidget):
    def __init__(self, parent=None):
        ...
        # self.project_help.setMaximumSize(22, 22)
        ...
        # self.input_help.setMaximumSize(22, 22)
    ...
    def grid_actions(self, btn):
        ...
        if btn.objectName() == 'grid_pymol_button' and btn.text() == 'Show in PyMol':
            ...
            files = glob.glob('%s*.map' % self.parent.v.analog_protein_name) + glob.glob(
                ...
                '%s*.gpf' % self.parent.v.analog_protein_name) + ['user_off_target_dim.txt', self.parent.v.FILL,
