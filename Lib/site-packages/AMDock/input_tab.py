...
class Program_body(QtGui.QWidget):
    def __init__(self, parent=None):
        ...
        self.sc_area_layout = QtGui.QVBoxLayout(self.sc_area)
        self.sc_area_layout.addWidget(self.project_box)
        self.sc_area_layout.addWidget(self.input_box)
        self.sc_area_layout.addWidget(self.grid_box)
        self.sc_area_layout.addStretch(1)
