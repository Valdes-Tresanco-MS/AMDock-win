        ...
        if self.AMDock.section == 1:
            if self.AMDock.project.bsd_mode_target in [0, 1]:
                ...
                if prog_name == 'AutoGrid4':
                    self.progress(60,self.AMDock.project.mode, 'Running AutoGrid4 for Target...')
                ...
                if prog_name in  ['AutoLigand', 'AutoLigand_point']:
                    self.progress(100,self.AMDock.project.mode, 'Searching Ligand Binding Site in Target...')
