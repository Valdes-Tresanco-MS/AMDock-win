    ...
    def binding_site(self):
        ...
        if self.AMDock.od:
            if self.AMDock.analog_grid_def == 'auto':
                ...
                autoligand_argB = [str(self.AMDock.autoligand_py), '-r', str(self.AMDock.analog_protein_pdbqt[:-6]), '-a',
                                   str(self.AMDock.heavy_atoms)]
                ...
                autoligand_arg = [str(self.AMDock.autoligand_py), '-r', str(self.AMDock.analog_protein_pdbqt[:-6]), '-a',
