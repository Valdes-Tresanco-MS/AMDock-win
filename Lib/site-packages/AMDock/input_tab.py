...
from tools import GridDefinition, Fix_PQR, AddHLigand
...
class Program_body(QtGui.QWidget):
    def __init__(self, parent=None):
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.cross_reaction.setGeometry(QtCore.QRect(430, 25, 128, 22))
        ...
        self.protein1_column_label.setGeometry(QtCore.QRect(658, 10, 50, 22))
    ...
    def grid_actions(self,btn):
        if btn.objectName() == 'grid_pymol_button':
            visual_arg = [self.parent.ws.pymol,self.parent.v.protein_pdbqt, self.parent.ws.grid_pymol, '--', '-c',
                          self.parent.v.obj_center,'-s', '%s,%s,%s'%(self._size_x,self._size_y,self._size_z),'-p', 'target']
            self.box_pymol = {'pymol_boxA': [self.parent.ws.this_python, visual_arg]}
            self.b_pymol = Worker()
            ...
            visual_arg = [self.parent.ws.pymol, self.parent.v.analog_protein_pdbqt, self.parent.ws.grid_pymol, '--', '-c',
            ...
            build_arg = [self.parent.ws.pymol, self.parent.v.protein_pdbqt, self.parent.ws.build_pymol, '--','-s', '%s,%s,%s' % (self.parent.v.rg, self.parent.v.rg,
                                        self.parent.v.rg), '-p','target']
            self.box_pymol = {'pymol_buildA': [self.parent.ws.this_python, build_arg]}
            ...
            build_arg = [self.parent.ws.pymol, self.parent.v.analog_protein_pdbqt, self.parent.ws.build_pymol, '--','-s', '%s,%s,%s' % (self.parent.v.rg, self.parent.v.rg,
                                        self.parent.v.rg), '-p','control']
            self.box_pymolB = {'pymol_buildB': [self.parent.ws.this_python, build_arg]}
            ...
            if self.parent.v.program_mode is not 'SCORING':
                ...
                if len(errlist) != 0:
                    ...
                    if self.parent.v.cr:
                        ...
                        self.parent.result_tab.best_button.setGeometry(QtCore.QRect(420, 545, 140, 25))
                        self.parent.result_tab.all_button.setGeometry(QtCore.QRect(420, 575, 140, 25))
    ...
    def prepare_receptor(self):
        ...
        if self.parent.v.ligand_prepare:
            protonate_ligand_arg = ['pdb', self.parent.v.ligand_pdb, float(self.parent.v.pH), self.parent.v.ligand_h]
            self.protonate_ligand = {'function Protonate Ligand': [AddHLigand, protonate_ligand_arg]}
