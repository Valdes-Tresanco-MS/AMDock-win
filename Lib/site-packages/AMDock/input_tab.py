...
#         # self.grid_box.setEnabled(False)
        ...
        self.coor_xB = QtGui.QDoubleSpinBox(self.coor_box)
        ...
        self.coor_yB = QtGui.QDoubleSpinBox(self.coor_box)
        ...
        self.coor_zB = QtGui.QDoubleSpinBox(self.coor_box)
        ...
        self.size_xB = QtGui.QSpinBox(self.coor_box)
        ...
        self.size_yB = QtGui.QSpinBox(self.coor_box)
        ...
        self.size_zB = QtGui.QSpinBox(self.coor_box)
        ...
        # self.progressbar_layout.addWidget(self.reset_button, 2, 1)
    ...
    def prepare_receptor(self):
        ...
        if self.AMDock.od and self.offtarget_info.get_het():
