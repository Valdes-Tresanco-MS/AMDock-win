...
#         # self.grid_box.setEnabled(False)
        ...
        self.program_label = QtGui.QLabel('ihaihdihiahsidhiahsdi ashdiuhaisdhiahsd')
        ...
        self.progressbar_layout.addWidget(self.log_button, 1, 0)
        self.progressbar_layout.addWidget(self.program_label, 1, 1, 1, -1)
...
#         # self.AMDock.result_tab.load_button.setEnabled(False)
    ...
    def check_section(self, qname):
        ...
        if self.AMDock.section == 1:
            ...
            self.progressBar_section.setValue(0)
            self.AMDock.configuration_tab.log_wdw.textedit.append('AMDOCK: MD Molecular Docking...Done\n')
            self.go_result()
        elif self.AMDock.section == 4:
            self.progressBar_global.setValue(100)
            self.progressBar_section.setValue(0)
            self.AMDock.configuration_tab.log_wdw.textedit.append('AMDOCK: S Scoring...Done\n')
            self.go_scoring()
