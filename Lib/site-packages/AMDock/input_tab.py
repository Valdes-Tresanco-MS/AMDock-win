...
#         # self.grid_box.setEnabled(False)
    ...
    def autodock_output(self):
        ...
        # try:
        if self.AMDock.project.mode == 1:
            if self.AMDock.project.prog == 'AutoDock4' or self.AMDock.project.prog == 'AutoDock4ZN':
                self.ADout_file = os.path.join(self.AMDock.project.results, self.autodock_dlg)
            elif self.AMDock.project.prog == 'AutoDock4 B' or self.AMDock.project.prog == 'AutoDock4ZN B':
                self.ADout_file = os.path.join(self.AMDock.project.results, self.autodock_dlgB)
        else:
            if self.AMDock.project.prog == 'AutoDock4' or self.AMDock.project.prog == 'AutoDock4ZN':
                self.ADout_file = os.path.join(self.AMDock.project.results, self.autodock_dlg)
