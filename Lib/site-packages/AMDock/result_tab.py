...
class Results(QtGui.QWidget):
    ...
    def show_best(self, b):
        if b.objectName() == 'best_button':
            if self.AMDock.docking_program == 'AutoDock Vina':
                visual_arg = [self.AMDock.pymol, os.path.join(self.AMDock.project.results,
                              self.AMDock.target.vina_best), self.AMDock.lig_site_pymol]
            else:
                visual_arg = [self.AMDock.pymol, os.path.join(self.AMDock.project.results,
        ...
        if b.objectName() == 'all_button':
            if self.AMDock.docking_program == 'AutoDock Vina':
                visual_arg = [self.AMDock.pymol, os.path.join(self.AMDock.project.input, self.AMDock.target.pdbqt),
                              os.path.join(self.AMDock.project.results, self.AMDock.target.vina_all),
                              self.AMDock.protein_cartoon_pymol]
            else:
                visual_arg = [self.AMDock.pymol, os.path.join(self.AMDock.project.input, self.AMDock.target.pdbqt),
                              os.path.join(self.AMDock.project.results, self.AMDock.target.ad4_all),
                              self.AMDock.protein_cartoon_pymol]
            ...
            if self.AMDock.docking_program == 'AutoDock Vina':
                visual_arg = [self.AMDock.pymol, os.path.join(self.AMDock.project.input,
                                                                self.AMDock.offtarget.pdbqt),
                              os.path.join(self.AMDock.project.results, self.AMDock.offtarget.vina_all),
                              self.AMDock.protein_cartoon_pymol]
            else:
                visual_arg = [self.AMDock.pymol, os.path.join(self.AMDock.project.input,
                                                                self.AMDock.offtarget.pdbqt),
                              os.path.join(self.AMDock.project.results, self.AMDock.offtarget.ad4_all),
                              self.AMDock.protein_cartoon_pymol]
