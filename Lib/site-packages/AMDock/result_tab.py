...
class Results(QtGui.QWidget):
    ...
    def show_best(self, b):
        if b.objectName() == 'best_button':
            if self.parent.v.docking_program == 'AutoDock Vina':
                visual_arg = [self.parent.ws.pymol, os.path.join(self.parent.v.result_dir,
    ...
    def show_all(self, b):
        if b.objectName() == 'all_button':
            if self.parent.v.docking_program == 'AutoDock Vina':
                visual_arg = [self.parent.ws.pymol, os.path.join(self.parent.v.input_dir, self.parent.v.protein_pdbqt),
            ...
            if self.parent.v.docking_program == 'AutoDock Vina':
                visual_arg = [self.parent.ws.pymol, os.path.join(self.parent.v.input_dir,
                                                                self.parent.v.analog_protein_pdbqt),
