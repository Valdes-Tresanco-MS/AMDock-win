...
for o, a in opt_list:
    if o in ('-s', '--s'):
        size_x = int(float(a.split(',')[0]))
        size_y = int(float(a.split(',')[1]))
        size_z = int(float(a.split(',')[2]))
    if o in ('-c', '--c'):
        center_x = float(a.split(',')[0])
        center_y = float(a.split(',')[1])
        center_z = float(a.split(',')[2])
    if o in ('-p', '--p'):
        prot = a
